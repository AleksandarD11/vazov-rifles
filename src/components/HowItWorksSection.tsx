...
const steps = [
  {
    icon: ClipboardList,
    title: "Избираш реплика или услуга",
    text: "Започваш от арсенала, сервиза или конкретна custom идея.",
  },
  {
    icon: MessageSquare,
    title: "Изпращаш заявка",
    text: "Описваш какво търсиш и какъв е желаният резултат.",
  },
  {
    icon: Wrench,
    title: "Получаваш консултация",
    text: "Преглеждаме проекта и връщаме конкретни опции и оферта.",
  },
  {
    icon: CheckCircle2,
    title: "Потвърждаваш сетъпа",
    text: "Уточняваме конфигурацията преди работа или доставка.",
  },
  {
    icon: PackageCheck,
    title: "Получаваш готовия сетъп",
    text: "Финален тест, подготовка и предаване според договорката.",
  },
];
...
const HowItWorksSection = () => {
  return (
    <section className="relative overflow-hidden border-t border-white/5 bg-[#070707] py-14 sm:py-16 lg:py-24">
      <div className="pointer-events-none absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-red-600/5 blur-[120px] sm:h-[520px] sm:w-[520px]" />
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-10 max-w-3xl text-center sm:mb-14">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-gray-400 sm:text-base">
            Процесът е кратък и ясен: първо уточняваме нуждата, после конфигурацията, сроковете и следващата стъпка.
          </p>
        </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative min-w-0 rounded-3xl border border-white/10 bg-white/[0.035] p-5 backdrop-blur-xl"
              >
