...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#1a1a1a] bg-[#040404] px-6 py-12">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 md:flex-row">
        ...
        <div className="flex flex-col items-center gap-2 text-center md:items-end md:text-right">
          <p className="flex items-center gap-2 text-xs uppercase tracking-widest text-gray-500 transition-colors hover:text-white">
